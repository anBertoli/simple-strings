...
/*
 * Verify that the provided iterator produces the correct number of tokens,
 * and each of them equal to the corresponding token from the tokens list.
 * Additionally, each token generated by the iterator should have len = cap.
 */
void test_tokens_from_iter(ss_iter *s_iter, char **tokens, int num_tokens) {
    for (int i = 0; ; i++) {
...
/*
 * Verify that the provided strings list has the correct number of tokens,
 * and each of them equal to the corresponding token from the tokens list.
 * Additionally, each token in the list should have len = cap.
 */
void test_tokens_from_list(ss_list *str_list, char **tokens, int num_tokens) {
