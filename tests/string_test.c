...
void test_ss_new_from_raw_len_cap(void) {
    test_group("test ss_new_from_raw_len_cap");
...
void test_ss_new_from_raw_len(void) {
    test_group("test ss_new_from_raw_len");
...
void test_ss_new_from_raw(void) {
    test_group("test ss_new_from_raw");
...
void test_ss_new_empty_with_cap(void) {
    test_group("test ss_new_empty_with_cap");
